...
.badge-info    { background:rgba(22,163,74,0.12);  color:var(--success); }
.badge-warning { background:rgba(245,158,11,0.12); color:var(--warning-hover); }
.badge-alert   { background:rgba(239,68,68,0.12);  color:var(--danger); }
